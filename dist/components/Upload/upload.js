...
var Upload = function (props) {
    ...
    return (React.createElement("div", { className: 'viking-upload-component' },
        React.createElement("div", { className: 'viking-upload-input', onClick: handleClick, style: { display: 'inline-block' } },
            ...
            React.createElement("input", { className: 'viking-file-input', ref: fileInput, accept: accept, multiple: multiple, onChange: handleFileChange, style: { display: 'none' }, type: 'file' })),
